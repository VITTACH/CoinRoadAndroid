...
object BinanceBarSerializer : KSerializer<BinanceBarDto> {
    override val descriptor = PrimitiveSerialDescriptor("BinancePublicBars", PrimitiveKind.STRING)

    override fun deserialize(decoder: Decoder): BinanceBarDto {
        ...
        return BinanceBarDto(bar)
    }

    override fun serialize(encoder: Encoder, value: BinanceBarDto) {
    }
}